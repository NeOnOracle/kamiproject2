...
#
#
openai.api_key = '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'
...
def call_to_api(message):
    ...
    title_text2 = resultString.partition("\n")[0]
    # This gets the title
    global title_text
    for text in title_text2:
        if text == ":":
...
def random_option():
    #apiQuery = (
            # "Put the title of the dish first! Generate a random " + " recipe. User also has " +
            #query.getPrefStr() + ". Do not make " + title_text + " you have already made this!"
    #)
    apiQuery=("Generate a random recipe!" )
